...
Процедура ЗаполнитьПараметрыИнициализации(Запрос, ДокументСсылка)
	...
	Иначе
		УстановитьПараметрЗапросаЦифровойИндексОбособленногоПодразделения(Запрос, Реквизиты);
	КонецЕсли;
...
Процедура УстановитьПараметрЗапросаЦифровойИндексОбособленногоПодразделения(ОсновнойЗапрос, Реквизиты)
	...
	ЗапросПроверкиНаличияИндексов.УстановитьПараметр("Организация", Реквизиты.Организация);
