...
Процедура СформироватьУзлыКорректировкиСписанияСтоимости(ПараметрыРасчета)
	...
	|				ИЛИ УчетСебестоимости.ТипЗаписи = ЗНАЧЕНИЕ(Перечисление.ТипыЗаписейПартий.ДопРасходыСПартией)) ТОГДА
...
Процедура РешитьСЛУ(ПараметрыРасчета, РасчетСтоимостиРегл)
	...
	|	ЕСТЬNULL(
	|		МАКСИМУМ(
	|			ВЫБОР КОГДА (ЕСТЬNULL(ТаблицаРешений.ВременнаяРазница * ТаблицаРешений.ВременнаяРазницаЗнак,0)
	|			 - (ВременнаяТаблицаРешений.СвободныйКоэффициентВременнаяРазница * ВременнаяТаблицаРешений.ВременнаяРазницаЗнак
	|				+ ВременнаяТаблицаРешений.ВременнаяРазница)) > 0 ТОГДА
	|
	...
	|	ЕСТЬNULL(
	|		МАКСИМУМ(
	|			ВЫБОР КОГДА (ЕСТЬNULL(ТаблицаРешений.ПостояннаяРазница * ТаблицаРешений.ПостояннаяРазницаЗнак,0)
	|			 - (ВременнаяТаблицаРешений.СвободныйКоэффициентПостояннаяРазница * ВременнаяТаблицаРешений.ПостояннаяРазницаЗнак
	|				+ ВременнаяТаблицаРешений.ПостояннаяРазница)) > 0 ТОГДА
	|
